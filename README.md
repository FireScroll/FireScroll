...
| `GOSSIP_BROADCAST_MS`   | How frequently to broadcast gossip messages. This is only the partition ownership messages, not the protocol-level messages such as heartbeats. Default `1000`.                                                                                                                                                                                                                                           | int                                                                          |
| `KAFKA_SEEDS`           | CSV of (domain/ip):port for the Kafka node seeds.                                                                                                                                                                                                                                                                                                                                                         | string                                                                       |
| `KAFKA_TLS`             | int                                                                                                                                                                                                                                                                                                                                                                                                       | `1` to enable, turns on TLS support for Kafka connections                    |
| `KAFKA_USER`            | string                                                                                                                                                                                                                                                                                                                                                                                                    | Username for scram SHA256 auth, must also use `KAFKA_PASS` for it to be used |
| `KAFKA_PASS`            | string                                                                                                                                                                                                                                                                                                                                                                                                    | Password for scram SHA256 auth, must also use `KAFKA_USER` for it to be used |
...
| `REGION`                | Required. Region that this node is located in. Used to create a unique consumer group for region + replica group.                                                                                                                                                                                                                                                                                         | string                                                                       |
