...
Even with ~1000 requests per second running on a laptop, FireScroll is able to keep p98 of get requests <1ms and p99.99 partition operations <1ms, with most requests happening under 400us. Every request was pulling 2 records, each from their own partition:
